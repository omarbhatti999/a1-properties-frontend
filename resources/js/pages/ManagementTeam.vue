    ...
    <main>
        <section class="page-entry py-6">
            <div class="g-col-1 g-start-2 g-col-lg-8 g-start-lg-4 text-center">
                <h1 class="mb-2">The Management Team</h1>
                <p class="mt-5">Discover the leadership behind A1 Properties, where experience meets innovation. Our management team, led by Hanif Ebrahimi, is dedicated to excellence, client satisfaction, and shaping the future of Dubai's real estate market. Meet our visionary leaders and explore the A1 Properties difference today.</p>
            </div>
        </section>
        ...
        <div class="pb-9 vstack">
            <div class="page-entry" style="row-gap: 1rem;">
                ...
                <div class="g-col-3 g-start-1 g-col-lg-6 g-start-lg-2 pt-5 tab-content property-card-scroller-grid-item"
                    v-if="loading">
                ...
                <div class="g-col-3 g-start-1 g-col-lg-12 g-start-lg-2 p-0 tab-content property-card-scroller-grid-item">
                    <div class="property-card-scroller">
                        <ul class="property-card-grid" v-if="!loading">
                            <li class="property-card-grid__item card listing-cta-card hovering-bw"
                                v-for="item in team" @click="toListings(item.slug)">
                                <article class="property-card-body agent-card">
                                    <div class="ratio-5x7">
                                    ...
                                    <div class="post-card__body">
                                        ...
                                        <div class="centered-container" v-if="item.teamGroup == 'Associates'">
                                            <ul class="separator-list separator-list--dots">
                                        ...
                                        <button v-if="item.teamGroup == 'Associates'"
...
export default {
    ...
    created() {
        this.getTeam(this.selectedRole);
    },
    mounted() {
    },
    computed: {
