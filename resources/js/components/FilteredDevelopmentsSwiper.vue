<template>
    ...
    <div
        class="g-col-3 g-start-1 g-col-lg-12 g-start-lg-2 p-0 tab-content property-card-scroller-grid-item mt-0 border-bottom inside-section-pad">
        ...
        <div class="pb-5" v-if="!isMobile">
            ...
            <swiper :slides-per-view="4" :space-between="40" @swiper="onSwiper" @slideChange="onSlideChange"
                ...
                <swiper-slide v-for="item in projects.developments" :key="item.id" class="property-card-grid-scroller__item"
                    ...
                    <article class="development-card location-card" data-id="1480">
                        ...
                        <div class="development-card__body iw-card__body">
                            <div class="row">
                                ...
                                <div class="col-4 development-card__location-right">
                                    <span class="development-card__location-right">{{ item.developerName
                                    }}</span>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Only For Mobile -->
        <div class="property-card-scroller pb-0" v-else>
            ...
            <ul ref="propertyCardSlider" class="property-card-grid-scroller" :class="{ 'property-card-slider': !isMobile }"
                v-else>
                <li v-for="item in developments" :key="item.id" class="property-card-grid-scroller__item"
                    :class="{ 'property-card-slider_item': !isMobile }" @mouseover="handleHover(true, index)"
                    @mouseleave="handleHover(false)" @click="gotToAreaDetail(item.slug)">
                    <article class="development-card location-card" data-id="1480">
                        <div class="development-card__media iw-card__media">
        ...
        <div class="g-col-3 g-start-1 g-col-lg-12 g-start-lg-2 align-center mb-5 mt-0">
...
export default {
    ...
    computed: {
        ...mapState("developments", ["developments"]),
        maxScrollPosition() {
